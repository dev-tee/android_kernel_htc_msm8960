...
struct regulator_init_data operaul_pm8038_saw_regulator_core0_pdata =
	/*            ID  vreg_name            min_uV   max_uV */	
	SAW_VREG_INIT(S5, "8038_s5",	       850000, 1300000);
struct regulator_init_data operaul_pm8038_saw_regulator_core1_pdata =
...
struct rpm_regulator_platform_data operaul_rpm_regulator_pdata __devinitdata = {
